...
public:
	...
	BuildingTypes GetAIBestSpecialistBuilding();
	...
	bool DoRemoveWorstCitizen(bool bRemoveForcedStatus = false, SpecialistTypes eDontChangeSpecialist = NO_SPECIALIST);
	...
	void DoSpawnGreatPerson(UnitTypes eUnit);
